...
char entry[20];
String scrollString;
String displayString = "Los Lomitos";
int i;
int fps = 25 ;
int pauseflag = 0;
int memory = 0;
...
void loop()
{
  if (pauseflag != 1){
    if(memory == 0){
      ...
      m.clear();
              m.setColumn(10, B00000000);
              m.setColumn(11, B01110000);
              m.setColumn(12, B00011000);
              m.setColumn(13, B01111101);
              m.setColumn(14, B10110110);
              m.setColumn(15, B10111100);
              m.setColumn(16, B00111100);
              m.setColumn(17, B10111100);
              m.setColumn(18, B10110110);
              m.setColumn(19, B01111101);
              m.setColumn(20, B00011000);
              m.setColumn(21, B01110000);
              m.setColumn(22, B00000000);
              delay(2*1000/fps);
              m.setColumn(10, B00000000);
              m.setColumn(11, B00011110);
              m.setColumn(12, B00111000);
              m.setColumn(13, B10111101);
              m.setColumn(14, B01110110);
              m.setColumn(15, B00111100);
              m.setColumn(16, B00111100);
              m.setColumn(17, B00111100);
              m.setColumn(18, B01110110);
              m.setColumn(19, B10111101);
              m.setColumn(20, B00111000);
              m.setColumn(21, B00011110);
              m.setColumn(22, B00000000);
              delay(2*1000/fps);
    } 
